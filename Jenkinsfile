...
node ('infrastructure') {
    ansiColor('xterm') {
        ...
        doStageUnlessRelease('Deploy to Dev') {
            ...
            def extraHelmArgs =  "--recreate-pods --set image.tag='latest' --values dev.yaml"
        ...
        doStageIfPromoted('Deploy to Staging')  {
            ...
            def extraHelmArgs =  "--values staging.yaml"
        ...
        doStageIfRelease('Deploy to Production') {
            ...
            def extraHelmArgs =  "--set image.tag='${releaseTag}' --values prod.yaml"
